...
const ProgrammableCalculator = () => {
  ...
  return (
    <div className="px-8 pt-10 bg-gray-200 h-screen">
      <h1 className="text-2xl font-bold mb-4 text-black">Programmable Calculator</h1>
      <div className="mb-4">
      ...
      <div className="mb-4">
        <h2 className="text-xl font-bold mb-2 text-black">Stored Functions</h2>
